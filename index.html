...
<!-- counterup area end -->
    ...
    <section id="features" class="img-block-3col wrapper">
        <div class ="row">
            ...
            <div class ="col-md-6"><div class ="text-center"><h2><u>Features</u></h2></div>
        </div>
        <div class="container">
    ...
    <div class ="row">
        ...
        <div class ="col-md-6"><div class ="text-center"><h2><u>Testimonials</u></h2></div>
				...
				<div class="testimonial-section">
					...
					<div class="user-saying"style ="height:450px;overflow:hidden;">
						  <div class="swiper-container testimonial">
								  ...
								  <div class="swiper-pagination swiper-pagination-white"style="margin-top:-15%;margin-right:2%;"></div>
